...
struct Stream;
...
#if defined HC_BUILD_WEB || defined HC_BUILD_ANDROID || defined HC_BUILD_PSP || defined HC_BUILD_PSVITA || defined HC_BUILD_PS2
	#define BITMAPCOLOR_R_SHIFT  0
	#define BITMAPCOLOR_G_SHIFT  8
	#define BITMAPCOLOR_B_SHIFT 16
	#define BITMAPCOLOR_A_SHIFT 24
#elif defined HC_BUILD_3DS || defined HC_BUILD_N64 || defined HC_BUILD_WIIU
	...
	#define BitmapCol_R(color) ((hc_uint8)((color) >> BITMAPCOLOR_R_SHIFT))
	#define BitmapCol_G(color) ((hc_uint8)((color) >> BITMAPCOLOR_G_SHIFT))
	#define BitmapCol_B(color) ((hc_uint8)((color) >> BITMAPCOLOR_B_SHIFT))
	#define BitmapCol_A(color) ((hc_uint8)((color) >> BITMAPCOLOR_A_SHIFT))
	
	/* Converts input value into a packed color component */
	#define BitmapColor_R_Bits(value) ((hc_uint8)(value) << BITMAPCOLOR_R_SHIFT)
	#define BitmapColor_G_Bits(value) ((hc_uint8)(value) << BITMAPCOLOR_G_SHIFT)
	#define BitmapColor_B_Bits(value) ((hc_uint8)(value) << BITMAPCOLOR_B_SHIFT)
	#define BitmapColor_A_Bits(value) ((hc_uint8)(value) << BITMAPCOLOR_A_SHIFT)
#else
	/* Represents a packed RGBA colour, suitable for 3D graphics API textures and 2D window framebuffers. */
	typedef hc_uint16 BitmapCol;
	...
	/* Extracts just the R/G/B/A component from a bitmap color */
	#define BitmapCol_R(color) (((hc_uint8)(color >> BITMAPCOLOR_R_SHIFT) & 0x1F) << 3)
	#define BitmapCol_G(color) (((hc_uint8)(color >> BITMAPCOLOR_G_SHIFT) & 0x1F) << 3)
	#define BitmapCol_B(color) (((hc_uint8)(color >> BITMAPCOLOR_B_SHIFT) & 0x1F) << 3)
	#define BitmapCol_A(color) (((hc_uint8)(color >> BITMAPCOLOR_A_SHIFT) & 0x01) << 7)
	
	/* Converts input value into a packed color component */
	#define BitmapColor_R_Bits(value) (((hc_uint8)(value) >> 3) << BITMAPCOLOR_R_SHIFT)
	#define BitmapColor_G_Bits(value) (((hc_uint8)(value) >> 3) << BITMAPCOLOR_G_SHIFT)
	#define BitmapColor_B_Bits(value) (((hc_uint8)(value) >> 3) << BITMAPCOLOR_B_SHIFT)
	#define BitmapColor_A_Bits(value) (((hc_uint8)(value) >> 7) << BITMAPCOLOR_A_SHIFT)
#endif
...
#define Bitmap_DataSize(width, height) ((hc_uint32)(width) * (hc_uint32)(height) * 4)
...
HC_API void Bitmap_Scale(struct Bitmap* dst, struct Bitmap* src, 
						int srcX, int srcY, int srcWidth, int srcHeight);

#define PNG_SIG_SIZE 8
#if defined HC_BUILD_LOWMEM
...
*/
HC_API hc_result Png_Decode(struct Bitmap* bmp, struct Stream* stream);
