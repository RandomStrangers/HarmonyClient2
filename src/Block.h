...
HC_VAR extern struct _BlockLists {
	...
	hc_uint8 SpriteOffset[BLOCK_COUNT];
...
HC_API STRING_REF  hc_string Block_UNSAFE_GetName(      BlockID block);
typedef STRING_REF hc_string (*FP_Block_UNSAFE_GetName)(BlockID block);
...
extern hc_bool AutoRotate_Enabled;
...
hc_bool AutoRotate_BlocksShareGroup(BlockID block, BlockID blockOther);
