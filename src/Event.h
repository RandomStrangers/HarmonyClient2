...
typedef void (*Event_Entry_Callback)(void* obj, struct Stream* stream, const hc_string* name);
struct Event_Entry {
...
typedef void (*Event_Chat_Callback)(void* obj, const hc_string* msg, int msgType);
struct Event_Chat {
	Event_Chat_Callback Handlers[EVENT_MAX_CALLBACKS];
	void* Objs[EVENT_MAX_CALLBACKS]; int Count;
};

typedef void (*Event_Input_Callback)(void* obj, int key, hc_bool repeating, struct InputDevice* device);
struct Event_Input {
	Event_Input_Callback Handlers[EVENT_MAX_CALLBACKS];
	void* Objs[EVENT_MAX_CALLBACKS]; int Count;
};

typedef void (*Event_String_Callback)(void* obj, const hc_string* str);
struct Event_String {
...
typedef void (*Event_PluginMessage_Callback)(void* obj, hc_uint8 channel, hc_uint8* data);
struct Event_PluginMessage {
	Event_PluginMessage_Callback Handlers[EVENT_MAX_CALLBACKS]; 
	void* Objs[EVENT_MAX_CALLBACKS]; int Count;
};

typedef void (*Event_LightingMode_Callback)(void* obj, hc_uint8 oldMode, hc_bool fromServer);
...
HC_API void Event_Register(struct Event_Void* handlers,   void* obj, Event_Void_Callback handler);
/* Unregisters a callback function for the given event. */
HC_API void Event_Unregister(struct Event_Void* handlers, void* obj, Event_Void_Callback handler);
...
HC_API void Event_RaiseVoid(struct Event_Void* handlers);
...
HC_API void Event_RaiseInt(struct Event_Int* handlers, int arg);
/* Calls all registered callbacks for an event which has a float argument. */
HC_API void Event_RaiseFloat(struct Event_Float* handlers, float arg);
...
HC_VAR extern int EventAPIVersion;

HC_VAR extern struct _EntityEventsList {
...
HC_VAR extern struct _TabListEventsList {
...
HC_VAR extern struct _TextureEventsList {
...
HC_VAR extern struct _GfxEventsList {
...
HC_VAR extern struct _UserEventsList {
...
HC_VAR extern struct _BlockEventsList {
...
HC_VAR extern struct _WorldEventsList {
...
HC_VAR extern struct _ChatEventsList {
...
HC_VAR extern struct _WindowEventsList {
...
HC_VAR extern struct _InputEventsList {
...
HC_VAR extern struct _PointerEventsList {
...
HC_VAR extern struct _ControllerEventsList {
	struct Event_PadAxis AxisUpdate; /* Raw analog controller movement */
} ControllerEvents;

HC_VAR extern struct _NetEventsList {
