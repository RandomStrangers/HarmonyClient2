#ifndef HC_ENVRENDERER_H
#define HC_ENVRENDERER_H
#include "Core.h"
HC_BEGIN_HEADER
...
hc_bool EnvRenderer_ShouldRenderSkybox(void);

extern hc_int16* Weather_Heightmap;
...
HC_NOINLINE int EnvRenderer_CalcFlags(const hc_string* mode);
