#ifndef HC_SYSTEMFONTS_H
#define HC_SYSTEMFONTS_H
#include "Core.h"
HC_BEGIN_HEADER
...
typedef void (*SysFont_RegisterCallback)(const hc_string* path);
...
HC_API void SysFonts_GetNames(struct StringsBuffer* buffer);
